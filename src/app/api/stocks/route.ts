...
function convertLiveQuoteToStock(quote: LiveQuote): Stock & { isLive: boolean; lastUpdated: number } {
  ...
  return {
    ...
    country: quote.country || 'Nigeria',
    employees: quote.employees,
    exchange: quote.exchange || 'NSENG',
    ...
    evToEbitda: quote.evToEbitda,
    evToRevenue: quote.evToRevenue,
    pegRatio: quote.pegRatio,
    bookValue: quote.bookValue,
    tangibleBookValue: quote.tangibleBookValue,
    revenuePerShare: quote.revenuePerShare,
    cashPerShare: quote.cashPerShare,
    basicSharesOutstanding: quote.basicSharesOutstanding,
    returnOnCapital: quote.returnOnCapital,
    beta: quote.beta1Year,
