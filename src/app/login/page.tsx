          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900/70 backdrop-blur-xl py-8 px-4 shadow-2xl rounded-2xl sm:px-10 border border-slate-800/50">
              ...
              <button
                ...
                className="group/btn relative w-full flex items-center justify-center gap-3 py-3.5 px-4 border border-slate-700/50 rounded-xl shadow-sm text-sm font-semibold text-white bg-slate-800/50 hover:bg-slate-700/50 transition-all mb-3 overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <button
                ...
                className="group/btn relative w-full flex items-center justify-center gap-3 py-3.5 px-4 border border-slate-700/50 rounded-xl shadow-sm text-sm font-semibold text-white bg-slate-800/50 hover:bg-slate-700/50 transition-all mb-6 overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-slate-500/10 via-slate-400/10 to-slate-500/10 opacity-0 group-hover/btn:opacity-100 transition-opacity" />
                {isAppleLoading ? (
                  <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" />
                ) : (
                  <>
