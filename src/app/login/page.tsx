        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
          <div className="relative group">
            ...
            <div className="relative bg-slate-900/70 backdrop-blur-xl py-8 px-4 shadow-2xl rounded-2xl sm:px-10 border border-slate-800/50">
              <a
                href="/api/auth/login"
                className="group/btn relative w-full flex items-center justify-center gap-3 py-3.5 px-4 border border-slate-700/50 rounded-xl shadow-sm text-sm font-semibold text-white bg-slate-800/50 hover:bg-slate-700/50 transition-all mb-6 overflow-hidden"
              >
