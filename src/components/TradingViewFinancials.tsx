...
function TradingViewFinancials({ symbol, height = 830 }: TradingViewFinancialsProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg dark:shadow-slate-900/50 border border-gray-100 dark:border-slate-700 overflow-hidden">
      <div className="flex items-center gap-2 px-4 py-3 border-b border-gray-100 dark:border-slate-700">
        <BarChart2 className="text-purple-600 dark:text-purple-400" size={24} />
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white flex-1">
          Financials
        </h3>
        <a 
          href={`https://www.tradingview.com/symbols/NSENG-${cleanSymbol}/financials-overview/`}
          target="_blank"
